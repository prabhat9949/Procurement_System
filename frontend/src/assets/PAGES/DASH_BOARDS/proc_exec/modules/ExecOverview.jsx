...
import { ClipboardCheck, FileText, Send, FileCheck2, ShoppingBag, IndianRupee, Users, PackageCheck } from "lucide-react";
import LiveRoleOverview from "../../shared_ui/LiveRoleOverview";
import { formatINR, formatDateIN } from "../../../../../utils/format";

const ExecOverview = ({ onNavigate }) => {
  ...
  return (
    <LiveRoleOverview
      ...
      actions={[
        { label: "RFQ Management", icon: Send, primary: true, onClick: () => onNavigate("rfq-management") },
      ]}
      endpoints={{
